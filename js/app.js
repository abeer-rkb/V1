...
// side bar 
let show_side_bar = document.querySelector('#show-side-bar');
let hide_side_bar = document.querySelector('body >  nav.side-bar > #cancel');
let side_bar = document.querySelector('body >  nav.side-bar ');
...
if (hide_side_bar) {
    hide_side_bar.addEventListener('click', e => {
        side_bar.style.marginLeft = '-1000';
    });
}
